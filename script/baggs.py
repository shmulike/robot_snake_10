...
# Path for csv files
Realangle_file_name = '/home/robot-snake/rs_ws/src/robot_snake_10/bags/joint_val101.csv'
SIN_file_name = '/home/robot-snake/rs_ws/src/robot_snake_10/bags/joint_cmd101.csv'
motor_file = '/home/robot-snake/rs_ws/src/robot_snake_10/bags/motor_cmd101.csv'
tension_file = '/home/robot-snake/rs_ws/src/robot_snake_10/bags/tension_val101.csv'
...
ax.scatter(x_circle, y_circle, z_circle)
ax.scatter(circle_move_real[:,0],circle_move_real[:,1],circle_move_real[:,2])
ax.set_xlabel('x')
ax.set_ylabel('y')
ax.set_zlabel('z')
plt.show()
